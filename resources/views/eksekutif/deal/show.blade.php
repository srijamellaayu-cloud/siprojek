...
<div class="card deal-task-card mt-3">
    <div class="card-header d-flex justify-content-between align-items-center flex-wrap gap-2 deal-task-header">
        ...
        <form id="taskFilterForm" method="GET" action="{{ route('eksekutif.deal.show', $deal->id) }}" class="d-flex align-items-center justify-content-end gap-2 flex-wrap ms-auto" aria-label="Filter tugas proyek">
    ...
    <div class="table-responsive">
        <table class="table mb-0 align-middle deal-task-table">
            ...
            <tbody>
                ...
                @empty
                <tr>
                    <td colspan="4" class="text-center text-muted py-4">Belum ada tugas proyek</td>
                </tr>
                @endforelse
            </tbody>
        </table>
...
<div class="d-flex align-items-center gap-2 mt-3">
    <a href="{{ route('eksekutif.deal.index') }}" class="btn btn-sm app-chip deal-cancel-btn">Keluar</a>
    <a href="{{ route('eksekutif.deal.invoice', $deal->id) }}" target="_blank" rel="noopener" class="btn btn-sm app-chip deal-invoice-bottom-btn">Laporan</a>
</div>
...
<style>
    ...
    .deal-task-table thead th:nth-child(1),
    .deal-task-table tbody td:nth-child(1) {
        width: 32%;
    }

    .deal-task-table thead th:nth-child(2),
    .deal-task-table tbody td:nth-child(2) {
        width: 38%;
    }

    .deal-task-table thead th:nth-child(3),
    .deal-task-table tbody td:nth-child(3) {
        width: 15%;
    }

    .deal-task-table thead th:nth-child(4),
