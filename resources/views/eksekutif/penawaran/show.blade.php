...
<div class="d-flex align-items-center gap-2 mt-4 project-show-actions">
    <a href="{{ route('eksekutif.penawaran.index') }}" class="btn app-chip project-show-cancel-btn">Keluar</a>
    <a href="{{ route('eksekutif.penawaran.invoice', $penawaran->id) }}" target="_blank" rel="noopener" class="btn app-chip project-show-invoice-btn">Laporan</a>
</div>
