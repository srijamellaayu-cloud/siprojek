...
<div class="card shadow-sm mb-4 deal-page-card">
    <div class="card-header d-flex justify-content-between align-items-center flex-wrap gap-2 deal-header">
        ...
        <form id="filterForm" method="GET" action="{{ route('keuangan.deal.index') }}" class="deal-filter-form">
                ...
                <tr>
                    ...
                    <td>
                        <div class="deal-actions">
                            <a href="{{ route('keuangan.deal.show', $item->id) }}" class="btn btn-sm app-chip btn-primary deal-action-btn deal-action-btn-primary">Detail</a>
                        </div>
                    </td>
                </tr>
                @empty
