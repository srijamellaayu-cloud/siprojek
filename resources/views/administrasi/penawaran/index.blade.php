...
<div class="card shadow-sm mb-4 penawaran-page-card">
    <div class="card-header d-flex justify-content-between align-items-center flex-wrap gap-2 penawaran-header">
        ...
        <form id="filterForm" method="GET" action="{{ route('administrasi.penawaran.index') }}" class="penawaran-filter-form">
            <div class="ml-auto d-flex align-items-center position-relative penawaran-filter-controls" id="penawaranContainer">
                ...
                <a href="{{ route('administrasi.penawaran.create') }}" class="penawaran-add-btn">
                    + Tambah Data
                </a>
            </div>
        </form>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <div class="penawaran-status-hover" tabindex="0">
                            <span class="penawaran-status-badge penawaran-status-pill {{ $statusClass }}">
                                Menunggu Persetujuan
                            </span>

                            <div class="penawaran-status-actions">
                                <form action="{{ route('administrasi.penawaran.status.update', $item->id) }}" method="POST" class="penawaran-status-form">
                                    @csrf
                                    @method('PATCH')
                                    <input type="hidden" name="status" value="Disetujui">
                                    <button type="submit" class="btn btn-sm app-chip penawaran-action-btn penawaran-action-btn-approved js-status-confirm" data-status="Disetujui">Disetujui</button>
                                </form>
                                ...
                                <form action="{{ route('administrasi.penawaran.status.update', $item->id) }}" method="POST" class="penawaran-status-form">
                                    ...
                                    <input type="hidden" name="catatan_penolakan" class="js-reject-note" value="">
                                    <button type="submit" class="btn btn-sm app-chip penawaran-action-btn penawaran-action-btn-rejected js-status-confirm" data-status="Ditolak">Ditolak</button>
                                </form>
                            </div>
                        </div>
                        @else
                    ...
                    <td>
                        <div class="penawaran-actions {{ $item->status === 'Ditolak' ? 'is-rejected-row' : '' }}">
                            <a href="{{ route('administrasi.penawaran.show', $item->id) }}" class="btn btn-sm app-chip btn-primary penawaran-action-btn penawaran-action-btn-primary">Detail</a>
                            ...
                            @else
                            <a href="{{ route('administrasi.penawaran.edit', $item->id) }}" class="btn btn-sm app-chip btn-danger penawaran-action-btn penawaran-action-btn-danger">Update</a>
                            @endif
                        </div>
                    </td>
                </tr>
