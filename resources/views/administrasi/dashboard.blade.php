                ...
                <table class="table table-hover mb-0 dashboard-table align-middle">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $item->mitra }}</td>
                            <td class="text-center">
                                <a href="{{ route('administrasi.penawaran.show', $item->id) }}" class="btn btn-sm btn-primary dashboard-action-btn dashboard-action-btn-primary">Detail</a>
                            </td>
                        </tr>
                        @empty
                        <tr>
                ...
                <table class="table table-hover mb-0 dashboard-table dashboard-table-deal align-middle">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $item->mitra }}</td>
                            <td class="text-center">
                                <a href="{{ route('administrasi.deal.show', $item->id) }}" class="btn btn-sm btn-primary dashboard-action-btn dashboard-action-btn-primary">Detail</a>
                            </td>
                        </tr>
                        @empty
                        <tr>
