...
<div class="card shadow-sm mb-4 deal-page-card">
    <div class="card-header d-flex justify-content-between align-items-center flex-wrap gap-2 deal-header">
        ...
        <form id="filterForm" method="GET" action="{{ route('administrasi.deal.index') }}" class="deal-filter-form">
                ...
                <tr>
                    ...
                    <td>
                        <div class="deal-actions">
                            @if($progress >= 100)
                            <a href="{{ route('administrasi.deal.show', $item->id) }}" class="btn btn-sm app-chip btn-primary deal-action-btn deal-action-btn-primary" style="min-width: 182px; height: 31px !important;">Detail</a>
                            @else
                            <a href="{{ route('administrasi.deal.show', $item->id) }}" class="btn btn-sm app-chip btn-primary deal-action-btn deal-action-btn-primary">Detail</a>
                            <a href="{{ route('administrasi.deal.edit', $item->id) }}" class="btn btn-sm app-chip btn-danger deal-action-btn deal-action-btn-danger">Update</a>
                            @endif
                        </div>
                    </td>
                </tr>
