    ...
    <div class="login-container">
        ...
        <div class="right-panel">
            <div class="form-wrapper">
                ...
                <!-- Titles -->
                <h1 class="welcome-title">Welcome To<br>SiProjek!</h1>
                ...
                <form method="POST" action="{{ route('login') }}" class="login-form">
                    ...
                    <div class="input-group">
                        ...
                        <input id="email" type="email" name="email" class="input-field" value="{{ old('email') }}" placeholder="Enter your Email here" required autofocus autocomplete="username">
                        @if($errors->has('email'))
                    ...
                    <div class="input-group">
                        ...
                        <input id="password" type="password" name="password" class="input-field" placeholder="Enter your Password here" required autocomplete="current-password">
